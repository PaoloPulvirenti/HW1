...
function caricaPiatto(event)
{
    ...
    fetch("Controllo.php?em="+encodeURIComponent(String(img))+"&tit="+encodeURIComponent(String(titolo))+"&desc="+encodeURIComponent(String(descrizione))+"&t=caricaPiatto").then(fetchResponse).then(jsonCaricato);
